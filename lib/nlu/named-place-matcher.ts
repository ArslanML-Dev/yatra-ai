...
const ALIASES: Record<string, string[]> = {
  ...
  qaiserbagh: ["qaiserbagh", "qaisar bagh", "kaiserbagh", "kaiser bagh", "safed baradari"],
  ...
  "begum-hazrat-mahal-park": ["begum hazrat mahal park", "hazrat mahal park", "victoria park"],
